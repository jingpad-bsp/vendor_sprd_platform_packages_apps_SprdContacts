...
public class MultiContactDataCacheUtils implements Parcelable {
    ...
    private String mOtherColumnIndex = new String();
    ...
    public MultiContactDataCacheUtils(int mode, String mainIndex, String minorIndex, String otherIndex) {
        this.mode = mode;
        this.mMainColumnIndex = mainIndex;
        this.mMinorColumnIndex = minorIndex;
        this.mOtherColumnIndex = otherIndex;
    }
    ...
    private MultiContactDataCacheUtils(Parcel source) {
        ...
        mOtherColumnIndex = source.readString();
        mode = source.readInt();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(mOtherColumnIndex);
        dest.writeInt(mode);
    ...
    public void setColumnIndex(String mainIndex) {
        setColumnIndex(mainIndex, null, null);
    }

    public void setColumnIndex(String mainIndex, String minorIndex, String otherIndex) {
        this.mMainColumnIndex = mainIndex;
        this.mMinorColumnIndex = minorIndex;
        this.mOtherColumnIndex = otherIndex;
    }
    ...
    public void addCacheItem(Cursor cursor, Long contactId) {
        ...
        switch (mode) {
            case CacheMode.MULTI:
                ...
                if (mMainColumnIndex != null) {
                    result.put(mMainColumnIndex, cursor.getString(cursor.getColumnIndex(mMainColumnIndex)));
                }
                if (mMinorColumnIndex != null) {
                    result.put(mMinorColumnIndex, cursor.getString(cursor.getColumnIndex(mMinorColumnIndex)));
                }
                if (mOtherColumnIndex != null) {
                    result.put(mOtherColumnIndex, cursor.getString(cursor.getColumnIndex(mOtherColumnIndex)));
                }
    ...
    public void setModel(int mode, String mainIndex, String minorIndex, String otherIndex) {
        this.mode = mode;
        this.mMainColumnIndex = mainIndex;
        this.mMinorColumnIndex = minorIndex;
        this.mOtherColumnIndex = otherIndex;
