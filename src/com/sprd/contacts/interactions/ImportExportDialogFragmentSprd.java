package com.sprd.contacts.interactions;
...
public class ImportExportDialogFragmentSprd extends DialogFragment{
    ...
    public static void show(FragmentManager fragmentManager, boolean contactsAreAvailable,
        ...
        // SPRD: Bug847148 java.lang.IllegalStateException: Can not perform this action after onSaveInstanceState
        fragment.showAllowingStateLoss(fragmentManager, ImportExportDialogFragmentSprd.TAG);
    }
