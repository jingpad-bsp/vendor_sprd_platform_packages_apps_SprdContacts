...
public class SelectAccountActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        /*
        * SPRD:Bug 720026 Contacts shouldnot been import to simcard when select exchange email to import
        * @{
        */
    ...
    /**
     * SPRD:Bug 702117 After the exchange account has logged in, import vcf file and close the contacts any permissions
     * in the account select interface, the account select interface will show twice.
     * @{
     */
    @Override
    protected void onStop() {
        super.onStop();
        dismissDialog(R.string.import_from_vcf_file);
        finish();
    }
    /**
     * @}
