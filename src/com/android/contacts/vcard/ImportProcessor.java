    ...
    private void runInternal() {
        ...
        if (successful) {
            ...
            if (isCancelled()) {
                 ...
                 * @{
                 */
                if (mService.isDestAccountRemoved()) {
                    Log.i(LOG_TAG, "dest account does not exist, delete the contacts of this dest account");
                    Uri delete_uri = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "copy_accounts");
                    String[] arg = new String[]{account.type, account.name};
                    mResolver.delete(delete_uri, null, arg);
                }
                /**
                 * @}
                 */
