...
public class ContactLoader extends AsyncTaskLoader<Contact> {
    ...
    private static class ContactQuery {
        ...
        /**
         * UNISOC:bug693214 display contacts in QuickContactActivity.
         *
         * @{
         **/
        public final static int DISPLAY_ACCOUNT_NAME = 62;
        public final static int DISPLAY_ACCOUNT_TYPE = 63;
        public final static int RAW_CONTACT_IS_READ_ONLY = 64;
        public static final int CARRIER_PRESENCE = 65;
        /**
         * @}
         */
    }
    ...
    private void loadPhotoBinaryData(Contact contactData) {
        ...
        if (photoUri != null) {
            try {
                ...
                //SPRD Bug 862936 After unlock screen,the resolution of the avatar is down.
