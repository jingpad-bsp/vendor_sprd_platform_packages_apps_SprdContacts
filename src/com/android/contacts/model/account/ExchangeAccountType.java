...
public class ExchangeAccountType extends BaseAccountType {
    ...
    /**
     * UNISOC: Bug917537 It is not show email account into side navigation drawer of contacts for go pac.
     * @{
     * */
    private static final String ACCOUNT_TYPE_GOOGLE_3 = "com.google.android.gm.exchange.lite";
    /**
     * @}
     * */
    ...
    public static boolean isExchangeType(String type) {
        return ACCOUNT_TYPE_AOSP.equals(type) || ACCOUNT_TYPE_GOOGLE_1.equals(type)
                || ACCOUNT_TYPE_GOOGLE_2.equals(type) || ACCOUNT_TYPE_GOOGLE_3.equals(type);
    }
    /**
     * @}
     * */
