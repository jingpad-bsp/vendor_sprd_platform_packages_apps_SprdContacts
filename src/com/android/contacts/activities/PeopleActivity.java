...
public class PeopleActivity extends AppCompatContactsActivity implements
    ...
    //SPRD: 881350,900454 Home key exit and click into the contacts again, the interface display anomaly.
    ...
    /**
     * Bug 784388 add warn location express when enter into contacts
     */
    ...
    private boolean areContactsAvailable() {
        ...
        return (mProviderStatus != null)
                && (mProviderStatus.equals(ProviderStatus.STATUS_NORMAL) || mProviderStatus
                        .equals(ProviderStatus.STATUS_IMPORTING));
        /**
         * @}
         */
    }
    ...
    protected void onCreate(Bundle savedState) {
        ...
        /**
         * SPRD:845054 Memory leaks in singleton mode@{
         **/
        mProviderStatusWatcher = ProviderStatusWatcher.getInstance(getApplicationContext());
        /**
         * @}
         **/
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (isGroupSaveAction(action)) {
            ...
            /**
             * SPRD: Bug726208 toast twice when remove group members
             * @{
             */
            if (GroupUtil.ACTION_REMOVE_FROM_GROUP.equals(action) && mMembersFragment != null
                    && !mMembersFragment.isInactive()) {
        ...
        if (!isInSecondLevel()) {
            /**
             * SPRD: Bug766291 com.android.contacts happens JavaCrash,log:java.lang.NullPointerException
             * SPRD: Bug803714 com.android.contacts happens JavaCrash,log:java.lang.IllegalArgumentException
             * @{
             */
    ...
    public void onBackPressed() {
        ...
        //SPRD: add for bug900570, key event before activity is resumed
        if (!isResumed()) {
            Log.d(TAG, "Back button is pressed before activity resumed");
            return;
        }
    ...
    private void onGroupMenuItemClicked(long groupId) {
        ...
        /**UNISOC:modify for the bug1057032 @{*/
        if (ContactsApplication.sApplication.isBatchOperation()
                || ContactSaveService.mIsGroupSaving
                || ContactSaveService.mIsJoinContacts) {
    ...
    private void switchView(ContactsView contactsView) {
        ...
        //SPRD: add for bug710427, java.lang.IllegalStateException: Can not perform this action after onSaveInstanceState
    ...
    private void resetFilter() {
        ...
        if (filter.filterType == ContactListFilter.FILTER_TYPE_CUSTOM) {
            setTitle(getString(R.string.title_from_custom));
        } else {
    ...
    private void selectAccountForNewGroup() {
        ...
        /*unisoc:1013619 iterator NullPointerException @{*/
        final List<AccountInfo> accounts;
        try {
            accounts = Futures.getUnchecked(AccountTypeManager.getInstance(this)
    ...
    public void onAccountChosen(AccountWithDataSet account, Bundle extraArgs) {
        ...
        /**
         * SPRD: Bug859441 monkey test,crash:com.android.contacts（java.lang.IllegalStateException）
         * @{
         */

        GroupNameEditDialogFragment.newInstanceForCreation(
                mNewGroupAccount, GroupUtil.ACTION_CREATE_GROUP)
                .showAllowingStateLoss(getFragmentManager(), TAG_GROUP_NAME_EDIT_DIALOG);
    ...
    /**
     * SPRD: Bug709842 In the contact search interface, after calling the touch assistant click on the search,
     * there is  a green line in the bottom of the contact search box.
     * @{
     */
    @Override
    ...
    private void configureSearchMode() {
        mContactsListFragment.getActionBarAdapter().setSearchMode(true);
        invalidateOptionsMenu();
    }

    private boolean isSelectionMode() {
        return mContactsListFragment.getActionBarAdapter().isSelectionMode();
    }
    private boolean isSearchMode() {
        return mContactsListFragment.getActionBarAdapter().isSearchMode();
    }
    /**
     * @}
     */
