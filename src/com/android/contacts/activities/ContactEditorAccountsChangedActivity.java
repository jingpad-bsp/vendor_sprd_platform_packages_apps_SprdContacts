...
public class ContactEditorAccountsChangedActivity extends Activity
    ...
    /**
     * SPRD:810489 Ensure that mDialog is dismiss() @{
     **/
    @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == SUBACTIVITY_ADD_NEW_ACCOUNT) {
            ...
            // the user.
            /**
             * SPRD:816377 Google logic problems, activcity do not need to be finish@{
             **/
    ...
    private void updateDisplayedAccounts(List<AccountInfo> accounts) {
        ...
        if (numAccounts >= 2) {
            ...
            /**
             * SPRD: Bug751823 account displays 'Phone' in Chinese language
             * Original Android code:
            textView.setText(getString(R.string.contact_editor_prompt_one_account,
                    accountInfo.getNameLabel()));
             * @{
             */
            CharSequence accountName = accountInfo.getNameLabel();
            if (accountName != null && "Phone".equals(accountName.toString())) {
                accountName = getString(R.string.label_phone);
            }
            textView.setText(getString(R.string.contact_editor_prompt_one_account, accountName));
            /**
             * @}
             */
