...
public abstract class ContactEntryListAdapter extends IndexerListAdapter {
    ...
    public void changeCursor(int partitionIndex, Cursor cursor) {
        if (partitionIndex >= getPartitionCount() || (cursor != null && cursor.isClosed())) {
...
//        }
    ...
    protected void bindHeaderView(View view, int partitionIndex, Cursor cursor) {
        ...
        countTextView.setText(R.string.search_results_searching);
        if (directoryPartition.isLoading()) {
            countTextView.setText(R.string.search_results_searching);
        } else {
            ...
            if (directoryId != Directory.DEFAULT
               ...
               countTextView.setText(mContext.getString(
                        R.string.foundTooManyContacts,
                        getDirectoryResultLimit()));
            } else {
                countTextView.setText(getQuantityText(count,
