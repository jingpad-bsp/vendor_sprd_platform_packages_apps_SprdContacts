...
public final class ContactListFilter implements Comparable<ContactListFilter>, Parcelable {
     ...
     * @{
     */
    public static final int FILTER_TYPE_GROUP_MEMBER = -9;
    public static final int FILTER_TYPE_GROUP_MEMBER_ONLY_PHONE_NUMBER = -10;
    /**
     * @}
     */
    ...
    */
    ...
    public ContactListFilter(int filterType, String accountType, String accountName, String dataSet,
            Drawable icon) {
        this(filterType, accountType, accountName, dataSet, icon, null, 0, null);
    }

    public ContactListFilter(int filterType, String accountType, String accountName, String dataSet,
            Drawable icon, ArrayList<AccountWithDataSet> accounts) {
        this(filterType, accountType, accountName, dataSet, icon, accounts, 0, null);
    }
    ...
    public static ContactListFilter createAccountsFilter(ArrayList<AccountWithDataSet> accounts) {
        return new ContactListFilter(ContactListFilter.FILTER_TYPE_ACCOUNTS, null,
                     null, null, null, accounts, 0, null);
     ...
     */
    /**
     * Sprd:754290 SIM card hot plug, contacts list does not display SIM card contacts
     * @{
     *
     **/
    public static ContactListFilter createFilterWithType(int filterType,
            ...
            if (filterType == FILTER_TYPE_ALL_ACCOUNTS && context != null) {
                List<AccountWithDataSet> allAccounts = AccountTypeManager.getInstance(context).getAccounts(false);
                ArrayList<AccountWithDataSet> accounts = new ArrayList<AccountWithDataSet>();
                accounts.addAll(allAccounts);
                return new ContactListFilter(FILTER_TYPE_ALL_ACCOUNTS, null, null, null, null, accounts);
            } else {
     ...
     */
     public ContactListFilter(int filterType, String accountType, String accountName,
             ...
             int onlyPhonesChanged, Long groupId) {
    ...
    public boolean equals(Object other) {
        ...
        /**
         * SPRD: Bug693204 Display contacts only with phone number.
         *       Bug715941 contacts display incorrect when does or not choose "Contacts with only numbers"
         *
         * @{
         */
         if (filterType == otherFilter.filterType) {
             ...
             if ((accounts == null && otherFilter.accounts != null)
                     ...
                     || (accounts != null && otherFilter.accounts != null && !accounts.equals(otherFilter.accounts))
                     || onlyPhonesChanged != otherFilter.onlyPhonesChanged) {
                 return false;
             }
         }
         /**
    ...
    public static final Parcelable.Creator<ContactListFilter> CREATOR =
        ...
        public ContactListFilter createFromParcel(Parcel source) {
            ...
            */
            ...
            int onlyPhonesChanged = source.readInt();
            return new ContactListFilter(filterType, accountType, accountName, dataSet, null,
                    accounts, onlyPhonesChanged, null);
            /**
            * @}
            */
        }
