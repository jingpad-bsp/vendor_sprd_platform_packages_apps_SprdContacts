...
public abstract class ContactEntryListFragment<T extends ContactEntryListAdapter>
    ...
    public boolean mExcludeReadOnly = false;
    /**
    ...
    protected void onPartitionLoaded(int partitionIndex, Cursor data) {
        if (partitionIndex >= mAdapter.getPartitionCount() || (data != null && data.isClosed())) {
    ...
    protected void configureAdapter() {
        ...
        if (mAdapter instanceof DefaultContactListAdapter) {
            DefaultContactListAdapter defaultAdapter = (DefaultContactListAdapter) mAdapter;
