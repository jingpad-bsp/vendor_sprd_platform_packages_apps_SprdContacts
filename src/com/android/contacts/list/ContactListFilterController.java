...
public abstract class ContactListFilterController {
    ...
    public abstract void selectCustomFilter(ContactListFilter filter);
...
class ContactListFilterControllerImpl extends ContactListFilterController {
    ...
    private void setContactListFilter(ContactListFilter filter, boolean persistent,
        ...
        /**
         * SPRD:BUG 760564 monkey test, contacts anr
         * @{
         **/
    ...
    //SPRD: Bug693204 Display contacts only with phone number.
    @Override
    public void selectCustomFilter(ContactListFilter filter) {
