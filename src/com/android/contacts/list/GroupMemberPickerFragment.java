...
public class GroupMemberPickerFragment extends
    ...
    //UNISOC: add for bug1041131, limit selected to 3,500 contacts.
    private static final int MAX_SELECTED_CONTACTS_COUNT = 3500;
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        if (data != null) {
            ...
            bindListHeader(getContext(), getListView(), accountFilterContainer,
                    accountWithDataSet, cursorWrapper.getCount(), true);
            /**
             * SPRD: Bug693205 Add group feature for Contacts
             * @{
             */
            mHasContacts = cursorWrapper.getCount() > 0 ? true : false;
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        setVisible(menu, R.id.menu_select, mHasContacts && !isSearchMode && !isSelectionMode);
        /**
         * androido-poting bug474752, 736015 Add features with multiSelection activity in Contacts.
         *
         * @{
         */
        final boolean showSelectAllOption = mHasContacts && isSelectionMode && (!getAdapter().isAllContactSelected());
        setVisible(menu, R.id.menu_contacts_select_all, showSelectAllOption);
        final boolean showCancelAllOption = mHasContacts && isSelectionMode && (getAdapter().isAllContactSelected());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
         ...
         */
            ...
            //UNISOC: add for bug1041131, limit selected to 3,500 contacts.
            SelectAllContacts(MAX_SELECTED_CONTACTS_COUNT);
            return true;
