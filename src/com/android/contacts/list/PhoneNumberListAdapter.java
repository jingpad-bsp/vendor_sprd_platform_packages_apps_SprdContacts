...
public class PhoneNumberListAdapter extends ContactEntryListAdapter {
    ...
    public void configureLoader(CursorLoader loader, long directoryId) {
        ...
        if (isExtendedDirectory(directoryId)) {
            ...
            //SPRD: bug 708294 EditInfoAcvitity need show no sim contacts
            ...
            //SPRD:Bug 726356 In widget, it still show contact of email account when disable the email
            newSelection += getSelectionForAccount();
     ...
     * SPRD:Bug 726356 In widget,it still show contact of email account when disable the email @{
     */
    public String getSelectionForAccount(){
        ...
        for (int i = 0; i < accounts.size(); i++) {
            selection.append("(" + RawContacts.ACCOUNT_TYPE + "='" + accounts.get(i).type + "' AND "
    ...
    private void applyFilter(CursorLoader loader, Uri.Builder uriBuilder, long directoryId,
        ...
        switch (filter.filterType) {
            ...
            case ContactListFilter.FILTER_TYPE_ACCOUNTS:{
                List<AccountWithDataSet> accounts = filter.accounts;
                if (accounts != null) {
