...
public class CustomContactListFilterActivity extends Activity implements
    ...
    public static class CustomFilterConfigurationLoader extends ListenableFutureLoader<AccountSet> {
        ...
        private AccountSet createAccountSet(List<AccountInfo> sourceAccounts) {
            ...
            for (AccountInfo info : sourceAccounts) {
                ...
                /**
                 * SPRD: Bug723189 Custom display contact, the machine will display deleted groups
                 * Original Android code:
                final Cursor cursor = resolver.query(groupsUri.build(), null, null, null, null);
                 * @{
                 */
                final Cursor cursor = resolver.query(groupsUri.build(), null, "deleted=0", null, null);
                /**
                 * @}
                 */
                if (cursor == null) {
    ...
    protected static class DisplayAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            CharSequence displayAccountName = account.mAccountInfo.getNameLabel();
            if (displayAccountName != null && mContext != null && "Phone".equals(displayAccountName.toString())) {
                displayAccountName = mContext.getResources().getString(R.string.label_phone);
            }
            text1.setText(displayAccountName);
