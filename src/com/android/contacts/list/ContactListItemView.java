...
public class ContactListItemView extends ViewGroup
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isVisible(mAccountView)) {
            /**
             * SPRD:Bug559634 adjust the size of contact account icon.
             * @{
             */
        ...
        if (isVisible(mNameTextView)) {
            ...
            /**
             *SPRD:Bug384514 Contact name longer, delete contacts in the check interface.
             *SPRD:Bug505150 Third-part icons show in contactsitemlist.
             *SPRD:Bug606115 The DUT occurs text hidden in the huge font.
             * @{
             */
            if (isVisible(mCheckBox)) {
    ...
    public TextView getNameTextView() {
        if (mNameTextView == null) {
            ...
            /**
             * SPRD:Bug747939 Under the large font and large display, in the group removed contact interface, part of the contact display has been cut off.
             * @{
             */
            ...
            int padding = (int) (width / scale + 0.5f)/20;

            mNameTextView.setPadding(0,0, padding,0);
    ...
    public TextView getDataView() {
        if (mDataView == null) {
            ...
            mDataView.setTextAlignment(View.TEXT_ALIGNMENT_VIEW_START);
            /**
             * SPRD:bug 713430 Forced left display.
             */
            mDataView.setTextDirection(View.TEXT_DIRECTION_LTR);
            /**
             * @}
    ...
    public void setSnippet(String text) {
        if (TextUtils.isEmpty(text)) {
            ...
            if (ContactDisplayUtils.isPossiblePhoneNumber(text)) {
                 ...
                 * SPRD:bug 713430 Forced left display.
                 */
                mSnippetView.setTextDirection(View.TEXT_DIRECTION_LTR);
                /**
                 * @}
                 */
            } else {
