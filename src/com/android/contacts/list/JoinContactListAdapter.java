...
public class JoinContactListAdapter extends ContactListAdapter {
    ...
    public void configureLoader(CursorLoader cursorLoader, long directoryId) {
         ...
         * SPRD:Bug 723166 Join the contact, it still show contact of email account when disable the email
         * Original Android code:
        loader.setSelection(Contacts._ID + "!=?");
         * @{
         */
        StringBuilder selection = new StringBuilder();
        selection.append(Contacts._ID + "!=?" + " AND " + Contacts.DISPLAY_ACCOUNT_TYPE +
                " not in ( 'sprd.com.android.account.sim', 'sprd.com.android.account.usim') AND is_read_only=0");
        selection.append(getSelectionForAccount());
