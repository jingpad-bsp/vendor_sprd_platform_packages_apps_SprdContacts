...
public class MultiSelectEmailAddressesListFragment
    ...
    public void onPrepareOptionsMenu(Menu menu) {
         ...
         * @{
         */
        final MenuItem selectAllitem = menu.findItem(R.id.menu_contacts_select_all);
        selectAllitem.setVisible(!getAdapter().isAllContactSelected());
        final MenuItem cancelAllItem = menu.findItem(R.id.menu_contacts_cancel_all);
        cancelAllItem.setVisible(getAdapter().isAllContactSelected());
        /**
         * @}
         */
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
         ...
         * @{
         */
        } else if (item.getItemId() == R.id.menu_contacts_select_all) {
            SelectAllContacts();
            return true;
        } else if (item.getItemId() == R.id.menu_contacts_cancel_all) {
            CancelAllContacts();
            return true;
        }
        /**
