...
public class MultiShrinkScroller extends FrameLayout {
    ...
    public void initialize(MultiShrinkScrollerListener listener, boolean isOpenContactSquare,
        ...
        // UNISOC: add for bug1139881, name did not succeed in getting focus.
        mFullNameView.setSelected(true);
    ...
    public void setPhoneticName(String phoneticName) {
        ...
        /**
         * SPRD: Bug726139  When the font and display are the largest, the contact containing the name and PhoneticName  displays overlaps the photo.
         * @{
         */
        int mPhoneticNameViewLineCount = 0;
        if (!TextUtils.isEmpty(phoneticName)){
            mPhoneticNameViewLineCount = 1;
        }
        final int maximumHeaderTextSize =
                mMaximumFullNameViewHeight * mFullNameView.getLineCount()
                        + mMaximumPhoneticNameViewHeight * mPhoneticNameViewLineCount;
        /**
         * @}
         */
