...
public class GroupMembershipView extends LinearLayout
    ...
    private class GroupMembershipAdapter<T> extends ArrayAdapter<T> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            //UNISOC: add for bug1194914, group name is too long to display completely
    ...
    public void setGroupMetaData(Cursor groupMetaData) {
        /** UNISOC: modify for bug1189139 ,When the number of SIM groups reaches the limit, click save flash group selection box. @{ */
        if (this.mGroupMetaData != null && groupMetaData != null && this.mGroupMetaData.getCount() == groupMetaData.getCount()) {
    ...
    public void onClick(View v) {
        //UNISOC: add for bug1191613, hide softkeyboard when click group view.
        hideSoftKeyboard(v);
        ...
        /**
         * SPRD: Bug738607 sim card state changed, then new sim group in editor fragment, crash.
         * @{
         */
        if (mGroupList == null) {
            return;
