...
public final class SelectAccountDialogFragment extends DialogFragment
    ...
    public static void show(FragmentManager fragmentManager, int titleResourceId,
        ...
        // SPRD: Bug866235 java.lang.IllegalStateException: Can not perform this action after onSaveInstanceState
    ...
    public void onAccountsLoaded(List<AccountInfo> accounts) {
        ...
        //SPRD: add for bug720622, if account is null or empty, dismiss SelectAccountDialogFragment
        ...
        mAccountsAdapter.setAccounts(accounts, account);
        /**
         * @}
         */
        /**
         * UNISOC: Bug1399391 If no accounts exist, dismiss this dialog.
         * @{
         */
        List<AccountInfo> accountsDisplayed = mAccountsAdapter.getAccounts();
        if (accountsDisplayed == null || accountsDisplayed.isEmpty()) {
            this.dismissAllowingStateLoss();
        }
        /**
         * @}
