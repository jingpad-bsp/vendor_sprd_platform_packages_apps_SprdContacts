...
public class PhotoEditorView extends RelativeLayout implements View.OnClickListener {
    ...
    public boolean isWritablePhotoSet() {
        /**
         * SPRD: 718737 After disable the gallery, add a new contact and add the picture, after the photo is taken,
         * the photo is not displayed but the "Delete photo" button will show when click the picture again.
         *
         * @{
         */
        if (ContactPhotoManager.getInstance(getContext()).isTooBig){
