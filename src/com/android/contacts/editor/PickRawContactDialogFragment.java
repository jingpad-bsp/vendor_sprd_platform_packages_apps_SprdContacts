...
public class PickRawContactDialogFragment extends DialogFragment {
    ...
    private final class RawContactAccountListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            /** SPRD: Bug711567 AccountType is null after close contacts permissions
             * @{
             */
            if (account == null) {
                return view;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            if (!metadata.isUserProfile) {
                builder.setPositiveButton(R.string.contact_editor_add_linked_contact,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                /* UNISOC:bug 1035080 monkey quick click make context to null  @{*/
                                if (getActivity() == null) {
                                    return;
                                }
                                /*@}*/
                ...
                builder.setNegativeButton(R.string.contact_editor_unlink_contacts,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                mShouldFinishActivity = false;
                                 /* UNISOC:bug 1192550 monkey quick click make context to null  @{*/
                                if (getActivity() == null) {
                                    return;
                                }
                                /*@}*/
        ...
        //SPRD: add for bug716555, limit the join contacts to 10
        final AlertDialog dialog = builder.create();
        dialog.show();
        final Button button = dialog.getButton(AlertDialog.BUTTON_POSITIVE);
        if (mAdapter.getCount() >= 10 && button != null) {
