...
public class PhotoSourceDialogFragment extends DialogFragment {
    ...
    private static final String TAG = "PhotoSourceDialogFragment";
            ...
            public void onClick(DialogInterface dialogInterface, int which) {
                ...
                switch (choice.getId()) {
                    ...
                    case ChoiceListItem.ID_PICK_PHOTO:
                        Log.e(TAG ,"ChoiceListItem.ID_PICK_PHOTO");
                        listener.onPickFromGalleryChosen();
                        break;
                }
                // SPRD: Bug828403 java.lang.IllegalStateException: Can not perform this action after onSaveInstanceState
