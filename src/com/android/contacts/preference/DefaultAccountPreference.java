...
public class DefaultAccountPreference extends DialogPreference {
    ...
    public CharSequence getSummary() {
        ...
        if (defaultAccount == null || mAccounts == null ||
            ...
            CharSequence displaySummary = AccountInfo.getAccount(mAccounts, defaultAccount).getNameLabel();
            if (displaySummary != null && getContext() != null && "Phone".equals(displaySummary.toString())) {
                displaySummary = getContext().getResources().getString(R.string.label_phone);
            }
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        // SPRD Bug709699 it occured crash low probably for IndexOutOfBoundsException
